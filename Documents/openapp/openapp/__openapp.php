...
class openapp {
    ...
    public static function isLogin(){
        ...
        mail($Responsable->getEmail(), "Termina de postular tu proyecto", $HTML, $headers);
    }
    ...
    public static function EnviarMailConsulta($Email, $Nombre, $Asunto, $Comentario){
        ...
        ob_start();
            ...
            $Mail = new VMails();
            $Mail->agregarFunVars(get_defined_vars());
            $Mail->Consulta($Email, $Nombre, $Comentario);

        $HTML = ob_get_contents();
        ob_end_clean();

        if (mail("nahuel.m@grupopexo.com", $Asunto, $HTML, $headers));
    }
    ...
    public static function EnviarMailInscripcion($Proyecto){
        ...
        mail($Responsable->getEmail(), "Inscripci&oacute;n de tu proyecto", $HTML, $headers);
    }
