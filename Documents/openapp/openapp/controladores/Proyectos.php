...
class CProyectos {
    ...
    public function Ver(){
       if (GET::take("otro_0") == "true"){
        ...
        if((GET::take("Otro_0") == 'facebook')){
            
            $Vista->addPROPERTY("og:title","Ayudame en el Concurso Open App votando mi proyecto '".$Proyecto[0]['Nombre']."'");
    ...
    {
        $url = "http://openapp.com.ar/Proyectos/Ver/015CF";
        $json = json_decode(file_get_contents('http://graph.facebook.com/?id='.$url));
        echo intval($json->{'shares'});
