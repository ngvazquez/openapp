...
class CProyectos {
    ...
    public function Ver(){
        ...
        if(isset($Proyecto[0]['Logo']) AND !is_null($Proyecto[0]['Logo']) AND $Proyecto[0]['Logo'] != ""){
            ...
            $Vista->addPROPERTY("og:image","http://openapp.com.ar/img/sin_imagen_chica.png");
        }
    ...
    public function Inscripcion(){
        ...
        if(!is_null(GET::take("Id")) AND GET::take("Id") != "") {
            ...
            //if (GET::take("Id") == "fbook_bnner" || GET::take("Id") == "fbook_cont" || GET::take("Id") == "twtt" || GET::take("Id") == "adw" || GET::take("Id") == "nwltter" || GET::take("Id") == "medio"){
